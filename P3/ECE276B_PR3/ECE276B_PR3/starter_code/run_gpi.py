...
def main():
    ...
    while cur_iter * utils.time_step < utils.sim_time:
        ...
        # Apply control input
        next_state = utils.car_next_state(utils.time_step, cur_state, control, noise=True) # NOTE: IF you want to check the deterministic case, please change the q=1.0 to q=2.0 in the gpi.py file
